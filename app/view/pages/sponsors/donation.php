...
<div id="detail-pane" class="detail-pane">
        <div id="card-pane" class="card-pane">
            ...
            <div class="card none detail-card" style="height: 300px;">
                <div class="card-body">
                    <div class="card-image" style="text-align: center;margin-left: 15px;"><img src="../../../../public/images/donation.png" alt="hello"></div>
                    <div class="card-title" style="font-size: 2em;"><?= $row['Campaign_Name'] ?></div>
                    <div class="card-description" style="font-size: 1.2em;font-weight: 900;"><?= $row['Campaign_Date'] ?></div>
                    <button class="btn btn-success w-100" href="#">Sponse</button>
                </div>
            </div>
            <?php } ?>
        </div>
