...
<div class="panel">
    <div class="profile-picture">
        <img id="blah" src="/public/upload/sample.jpg" alt="" onclick="UploadImage()">
        <div class="centered" onclick="UploadImage()">
            <img src="/public/images/icons/camera.png" alt="" onclick="UploadImage()">
            <div id="uploadText" class="upload-text" onclick="UploadImage()">Upload Picture</div>
        </div>
...
<!--                            Medical officers, Nursing officers, Public Health Inspectors, Medical Laboratory technologists, junior staff members-->
                            ...
                            <select id="position" class="form-select " name='Branch_ID'>
                                ...
                                <option value="Bra_01">Nugegoda</option>
                                <option value="Bra_02">Kirulapona</option>
                                <option value="Bra_03">Kohuwala</option>
                                <option value="Bra_04">Maharagama</option>
                                <option value="Bra_05">Piliyandala</option>
                            </select>
                            <span class="error-text"></span>
                        </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-entity">
                        <div class="valid">
                            ...
                            <input id="joined date" class="form-input select-date form-date" required type="date" name="Joined_Date"
                                   value=>
                            <span class="error-text"></span>
                        </div>
                    </div>
