...
<div class="d-flex w-100 justify-content-center align-items-center">
    <div class="d-flex bg-white p-2 w-80">
        <form action="" method="post" class="w-70 d-flex gap-1 justify-content-center w-100">
            ...
            <div class="d-flex flex-column gap-1 justify-content-center m-3 w-80">
                ...
                <div class="d-flex justify-content-between align-items-center gap-2">
                    <div class="d-flex w-100 align-items-center">
                        ...
                        <input type="text" name="NIC" id="NIC" value="<?php echo $model->getNIC() ?>">
                    </div>
                    <div class="d-flex w-100 align-items-center">
                ...
                <div class="d-flex justify-content-between align-items-center gap-2">
                    ...
                    <div class="d-flex w-100 align-items-center">
                        ...
                        <input type="text" name="Address1" id="Address1" value="<?php echo $model->getAddress1() ?>">
                    </div>
                </div>
                <div class="d-flex justify-content-between align-items-center gap-2">
                    <div class="d-flex w-100 align-items-center">
                        <label for="Address2" class="w-40">Address 2</label>
                        <input type="text" name="Address2" id="Address2" value="<?php echo $model->getAddress2() ?>">
                    </div>
                    <div class="d-flex w-100 align-items-center">
                        <label for="City" class="w-40">City</label>
                        <input type="text" name="City" id="City" value="<?php echo $model->getCity() ?>">
                    </div>
                </div>
                <div class="d-flex justify-content-between align-items-center gap-2">
                    <div class="d-flex w-100 align-items-center">
                        <label for="Position" class="w-40">Position</label>
                        <select name="Position" id="Position" class="w-60">
