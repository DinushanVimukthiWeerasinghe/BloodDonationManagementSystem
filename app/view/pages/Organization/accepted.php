    ...
    <div id="detail-pane" class="detail-pane">
        ...
        <div id="card-pane" class="card-pane">
            ...
            <div class="card none detail-card">
                ...
                <div class="card-body">
                    <div class="card-title">Amal</div>
                    <div class="card-description">Rs: 15000</div>
                </div>
            </div>
            <div class="card none detail-card">
                <div class="card-image">
                    <img src='/public/upload/1.jpeg' alt="">
                </div>
                <div class="card-body">
                    <div class="card-title">Namal</div>
                    <div class="card-description">Rs: 25000</div>
                </div>
            </div>
        </div>
    </div>
